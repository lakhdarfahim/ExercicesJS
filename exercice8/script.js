...
var paragraphe = document.querySelector('em');
...
function cliqueImage() {
    ...
    var nombre_images_selected = selection.length;
    paragraphe.textContent = nombre_images_selected;
}


for (var index = 0; index < images.length; index++) {
    images[index].addEventListener('click', cliqueImage);
}
